...
function App() {
  ...
  return (
    ...
    <div className="container flex flex-col">
          <div className="main_container flex flex-row justify-around">
            ...
            <div className="left flex flex-col mt-10 "> 
                ...
                <span className="mt-2"> or 
                  <span className="font-semibold text-orange-500 p-2 cursor-pointer"
                    onClick={()=> handleSignUp()}>create an account</span></span>
